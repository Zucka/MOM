...
These messages are a series of bytes sent one at the time in the form of Hexadecimals and in the context of an UART\fixme{What is UART? Maybe make a footnote} framed message. \newline
\begin{tabular}{|l|l|l|}
\hline \hline
