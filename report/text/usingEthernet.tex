...
\fixme{linje 18 mangler vist et ord.}
...
\fixme{Skal genskrives} When there is no more information to be received from the website, which is seen in  the connection is closed and the JSON string is parsed for the relevant information on whether or not the user was successful \autoref{pageJSON}.\fixme{sætningens sammenhæng giver ikke mening.dette for venter jeg: When ....then .....}
