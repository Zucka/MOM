...
As mentioned in the General Design Concepts chapter, see \vref{chapter:concepts}, rules underwent some changes during development of the MOM system. The first layout was the development teams understanding and ideas about the concept, but as the web page was created it became apparent that the first layout was too advanced, with that reasoning the rule concept went from a many:to:many concept to a one:to:one concept.\\
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{images/CreateRuleFlowchart.png}
