...
This means that conditions such as \texttt{Controller is On} and \texttt{Controller is Off} is now incorporated into special action names.\fixme{Evt. få navnet på disse actions.}
